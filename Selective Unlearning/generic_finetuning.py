...
huggingface_token = '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'
import os
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="/scratch/mk8475/one_book/WHP", help="Where to store the final model.")
...
def main():
    ...
    dataset = load_from_disk("/scratch/mk8475/one_book/raw_text.hf")
    ...
    if args.tokenizer_name:
        tokenizer = AutoTokenizer.from_pretrained(args.tokenizer_name, use_fast=not args.use_slow_tokenizer,cache_dir = '/scratch/mk8475/cache')
    elif args.model_name_or_path:
        tokenizer = AutoTokenizer.from_pretrained(args.model_name_or_path, use_fast=not args.use_slow_tokenizer,cache_dir = '/scratch/mk8475/cache')
    else:
        raise ValueError(
    ...
    if args.model_name_or_path:
        model = AutoModelForCausalLM.from_pretrained(
            ...
            config=config,
            cache_dir = '/scratch/mk8475/cache'
        )
    else:
